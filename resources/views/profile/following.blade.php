        ...
        <div class="max-w-4xl mx-auto">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-400">247 people</p>
                        </div>
                    </div>
            ...
            <div class="px-6 pt-2 pb-6">
                ...
                <div
                    ...
                    <div class="flex items-center gap-4">
                        <a href="/profile/kurosawa" class="flex items-center gap-4">
                            <div
                                ...
                                <img src="https://media.mutualart.com/Images/2021_09/16/06/062056199/74f4bbf5-c7fd-42a3-9e70-1719fb282836.Jpeg"
                                    class="w-full h-full object-cover" alt="Kurosawa Avatar" />
                            </div>
                            <div>
                                <h3 class="font-semibold text-gray-100 hover:text-white transition-colors">Akira</h3>
